...
/**
 * This interface defines all of the remote features
 *  offered by the Game server
 *  
 * @author mouhyi
 *
 */
public interface RemoteGame extends Remote {
	...
	/**
	 * deletes a player from this game.
	 *  Should be called when a player folds out
	 * 
	 * @param userId - id of player to be removed
	 */
	 ...
	 * 
	 * @param userId - userId of the player making the bet
	 ...
	 * 
	 * @param userId - userId of the player making the bet player
	 * @param bet - value of the raise
	 ...
	 * 
	 * @param userId - player all in
	 */
	// TODO create All-in Button
	public void allIn(int userId) throws RemoteException;
	...
	public int getCurPlayer() throws RemoteException;
}
